...
## Rust lang references and links

- [Rust by practise](https://practice.rs/collections/hashmap.html)
- [Rust by examples](https://doc.rust-lang.org/rust-by-example/index.html)
- [Rust in details](https://web.mit.edu/rust-lang_v1.25/arch/amd64_ubuntu1404/share/doc/rust/html/book/second-edition/ch03-02-data-types.html)
...
## Rust tutorials on cryptography
...
- The Rules of References
  At any given time, you can have either but not both of: 1. One mutable reference. 2. Any number of immutable references.
...
// can put any kind of data inside an enum variant: strings, numeric types, or structs, for example
enum Message {
Quit,
Move { x: i32, y: i32 },
Write(String),
...
array.array.into_iter().enumerate() - iterates by value
